...
export const PRODUCT_CATEGORIES = [
  ...
  },
  {
    ...
    slug: "payung-promosi",
    name: "Payung Promosi",
    description: "Payung golf custom branded berkualitas tinggi — tersedia dalam berbagai warna, ukuran, dan teknik sablon. Ideal untuk merchandise korporat, souvenir event, dan promosi bisnis.",
    image: "/images/payung-signature-garage-navy.jpg",
    items: ["Payung Golf Custom", "Payung Fiber Otomatis", "Payung Sablon Full Panel", "Payung Corporate Gift"],
    color: "#1a1a2e",
    accent: "#e94560",
    seo: {
      title: "Payung Promosi Custom Bali | Payung Golf Sablon Branding | PT Kawan Baik Bali",
      description: "Supplier payung promosi custom Bali: payung golf sablon logo, payung fiber otomatis, corporate gift umbrella. Custom branding full panel, MOQ fleksibel, pengiriman seluruh Indonesia.",
    },
  },
  {
    id: 5,
...
export const PRODUCTS = [
  ...
  },
 {
  ...
  {
    id: 44,
    slug: "payung-cbm-biru-top-view",
    name: "Payung Golf Custom – CBM Distributor Plafon PVC Biru",
    category: "Payung Promosi",
    categorySlug: "payung-promosi",
    image: "/images/payung-cbm-biru-top-view.jpg",
    description: "Payung golf jumbo berwarna biru cerah dengan sablon logo CBM Distributor Plafon PVC dan tagline 'BringHome' — tampilan atas penuh warna, cocok untuk promosi B2B dan pameran bangunan.",
    gallery: [],
  },
  {
    id: 45,
    slug: "payung-berani-kita-beda-putih",
    name: "Payung Golf Custom – Berani Kita Beda (HS) Putih",
    category: "Payung Promosi",
    categorySlug: "payung-promosi",
    image: "/images/payung-berani-kita-beda-putih.jpg",
    description: "Payung golf full-print putih dengan branding 'Berani Kita Beda' dan multiple logo produk HS — cetak sublimasi menyeluruh di seluruh panel kanopi, eye-catching untuk campaign promosi.",
    gallery: [],
  },
  {
    id: 46,
    slug: "payung-cbm-merah-side",
    name: "Payung Golf Custom – CBM Distributor Plafon PVC Merah",
    category: "Payung Promosi",
    categorySlug: "payung-promosi",
    image: "/images/payung-cbm-merah-side.jpg",
    description: "Payung golf promosi warna merah bold dengan logo CBM Distributor Plafon PVC putih — rangka hitam, gagang merah, piping putih di tepi kanopi. Tampilan sisi yang kuat dan profesional.",
    gallery: [],
  },
  {
    id: 47,
    slug: "payung-mazari-group-hitam-side",
    name: "Payung Golf Custom – Mazari Group Hitam (Tampak Sisi)",
    category: "Payung Promosi",
    categorySlug: "payung-promosi",
  ...
  {
    id: 48,
    slug: "payung-mazari-group-hitam-top",
    name: "Payung Golf Custom – Mazari Group Hitam (Tampak Atas)",
    category: "Payung Promosi",
    categorySlug: "payung-promosi",
    image: "/images/payung-mazari-group-hitam-top.jpg",
    description: "Tampak atas payung golf premium Mazari Group — kanopi hitam full dengan logo emas di setiap panel, menampilkan coverage branding 360° yang konsisten dan prestisius.",
    gallery: [],
  },
  {
    id: 49,
    slug: "payung-golf-nf58-ungu",
    name: "Payung Golf Fiber Otomatis NF-58 – Ungu Silver",
    category: "Payung Promosi",
    categorySlug: "payung-promosi",
    image: "/images/payung-golf-nf58-ungu.jpg",
    description: "Payung golf 30\" fiber otomatis NF-58 warna ungu dengan lapisan silver di sisi dalam — anti-UV, rangka fiber tahan angin, gagang busa ergonomis, dilengkapi sarung kain. Tersedia untuk custom branding.",
    gallery: [],
  },
  {
    id: 50,
    slug: "payung-golf-nf58-biru-silver",
    name: "Payung Golf Fiber Otomatis NF-58 – Biru Silver",
    category: "Payung Promosi",
    categorySlug: "payung-promosi",
    image: "/images/payung-golf-nf58-biru-silver.jpg",
    description: "Payung golf 30\" fiber otomatis NF-58 kombinasi biru navy dan silver metalik — lapisan silver dalam memantulkan panas, rangka fiber ringan tahan angin, sarung kain inklusif. Siap custom logo.",
    gallery: [],
  },
];
